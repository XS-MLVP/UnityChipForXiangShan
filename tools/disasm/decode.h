...
public:
  ...
  // inline bool check_rvc_rd_rs_invalid() {
  //   uint64_t op = x(1, 0);
  //   uint64_t funct3 = x(15, 13);

  //   if (x(11, 7) == 0 && op == 0b01 && (funct3 == 0b000 || funct3 == 0b001 || funct3 == 0b010)) return true;
  //   else if ((x(11, 7) == 0 || x(11, 7) == 2) && op == 0b01 && funct3 == 0b011) return true;
  //   else if (x(11, 7) == 0 && op == 0b10 && (funct3 == 0b000 || funct3 == 0b010 || funct3 == 0b011)) return true;
  //   else return false;
  // }
