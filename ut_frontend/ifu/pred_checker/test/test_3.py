...
async def test_3_1(predchecker_env):
    print("Test 3_1: If prediction is correct, check instrRange")
...
@toffee_test.testcase  
async def test_3_2(predchecker_env):
    print("Test 3_2: RET/JAL prediction fault, pds gave a narrower range")
    sqr = pred_checker_sqr()
    mdl = pred_checker_mdl()
    res = []
    ref_res = []
...
@toffee_test.testcase
async def test_3_3(predchecker_env):
    print("Test 3_3: No-CFI/Invalid prediction, redriction range")
    sqr = pred_checker_sqr()
    mdl = pred_checker_mdl()
    res = []
    ref_res = []
