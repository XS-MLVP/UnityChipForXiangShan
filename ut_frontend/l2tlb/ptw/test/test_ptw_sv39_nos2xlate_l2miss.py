...
async def test_ptw_ptwcache_req_sv39_l2miss_nos2xlate_1gbpage(toffee_request: toffee_test.ToffeeRequest):
    ...
    #  63 62-61 60 - 54  53 - 10 9-8 7 - 0
    #  N  PBMT  Reserved   PPN   RSW DAGUXWRV
    #  0  0     0       0x40000           111        WR, indicating a 1GB page
    #                              0000000111
    ptw_bundle.io_mem_resp_bits.value = 0x10000007
    ...
    # pte ppn pte[53:10] 0x40000 >> 3 = 0x8000
    # resp ppn io_resp_bits_resp_entry_0_ppn[40:0] + io_resp_bits_resp_entry_0_ppn_low[2:0]
    assert 0x8000 == ptw_bundle.io_resp_bits_resp_entry_0_ppn.value
...
@toffee_test.testcase
async def test_ptw_ptwcache_req_sv39_l2miss_nos2xlate_1gbpage_ppn_misaligned(toffee_request: toffee_test.ToffeeRequest):
    ...
    # Page fault triggered: PPN 0x400 is not 1GB aligned.
    assert 1 == ptw_bundle.io_resp_bits_resp_entry_0_pf.value

    # pte ppn pte[53:10] 0x400 >> 3 = 0x80
    # resp ppn io_resp_bits_resp_entry_0_ppn[40:0] + io_resp_bits_resp_entry_0_ppn_low[2:0]
    #assert 0x80 == ptw_bundle.io_resp_bits_resp_entry_0_ppn.value
    #assert 0x0 == ptw_bundle.io_resp_bits_resp_entry_0_ppn_low.value
...
async def test_ptw_ptwcache_req_sv39_l2l1miss_nos2xlate_2mbpage(toffee_request: toffee_test.ToffeeRequest):
    ...
    #  63 62-61 60 - 54  53 - 10 9-8 7 - 0
    #  N  PBMT  Reserved   PPN   RSW DAGUXWRV
    #  0  0     0         0x200           111       WR, indicating a 2mb page
...
@toffee_test.testcase
async def test_ptw_ptwcache_req_sv39_l2l1miss_nos2xlate_2mbpage_ppn_misaligned(toffee_request: toffee_test.ToffeeRequest):
